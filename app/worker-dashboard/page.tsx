        ...
        {loading ? (
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <StatCard label="Total Assigned" value={totalProjects} icon={Briefcase} />
            ...
            <div className="card">
              <h2 className="font-semibold mb-4">My Assigned Projects</h2>
              {projects.length === 0 ? (
                <p className="text-gray-400 text-sm text-center py-8">No projects assigned yet.</p>
              ) : (
